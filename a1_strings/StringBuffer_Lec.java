...
public class StringBuffer_Lec {
    public static void main(String[] args) {
        ...
        System.out.println(sb.equals(sb1)); //In String this will compare the content but in StringBuffer this will compare the reference.
        ...
        // StringBuffer checkMethod2 = new StringBuffer("This is for demo Purpose");
